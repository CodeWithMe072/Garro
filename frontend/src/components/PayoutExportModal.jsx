...
const PayoutExportModal = ({ isOpen, onClose, initialFormat = 'pdf' }) => {
  ...
  const handleDownload = async () => {
    try {
      ...
      let endpoint = `${API_BASE}/api/admin/payouts/export?format=${fmtParam}&range=${range}`;
      ...
      link.href = url;
      link.setAttribute('download', `payout_settlements_${range}_${new Date().toISOString().split('T')[0]}.${fmtParam}`);
      ...
      console.error('Payout export download error:', err);
      setIsExporting(false);
        ...
        <div style={{ padding: '24px' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  ...
                  <div className="text-muted" style={{ fontSize: '11.5px' }}>Payout settlements recorded today</div>
                </div>
              </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  ...
                  <div className="text-muted" style={{ fontSize: '11.5px' }}>All settlements from current calendar month</div>
                </div>
              </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  ...
                  <div className="text-muted" style={{ fontSize: '11.5px' }}>Complete historical payout records</div>
                </div>
              </div>
          ...
          <div className="d-flex gap-2">
            ...
            <button
              ...
              disabled={isExporting}
              style={{ borderRadius: '12px', fontSize: '13.5px', background: 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)', border: 'none' }}
            >
              {isExporting ? (
                <>
