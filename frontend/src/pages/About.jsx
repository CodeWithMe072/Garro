          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="values-card">
                <div className="values-icon"><span className="material-icons-round">verified</span></div>
            ...
            <div className="col-md-4">
              <div className="values-card">
                <div className="values-icon"><span className="material-icons-round">local_shipping</span></div>
            ...
            <div className="col-md-4">
              <div className="values-card">
                <div className="values-icon"><span className="material-icons-round">shield</span></div>
