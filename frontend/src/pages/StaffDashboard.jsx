  ...
  return (
    <div className="staff-wrapper">
      ...
      <aside className="staff-sidebar">
        ...
        <span className="sb-label">My Work</span>
        <Link to="/admin/staff" className="sb-link active">
          <span className="si">⚡</span>My Dashboard
        </Link>
        <Link to="/my-bookings" className="sb-link">
          <span className="si">📋</span>All Bookings
        ...
        {['manager', 'superadmin', 'admin'].includes(user?.role) && (
          <>
            ...
            <span className="sb-label">Admin Access</span>
            <Link to="/admin" className="sb-link">
              <span className="si">📊</span>Full Dashboard
            </Link>
          </>
        )}
        ...
        <Link to="/home" className="sb-link">
          <span className="si">🌐</span>Back to Site
        </Link>
      </aside>
      ...
      <main className="staff-main">
        <div className="dash-header">
          <div>
            ...
            <div className="dash-subtitle">Welcome back, {user?.firstName || 'Staff'}!</div>
          </div>
        </div>
        ...
        <div className="schedule-card">
          <div className="schedule-head">
            <h4>📅 Today's Schedule <span className="today-badge">Active Jobs</span></h4>
            <span style={{ fontSize: '13px', color: '#64748b' }}>{mappedBookings.length} jobs assigned</span>
          </div>
                    ...
                    <div className="tl-actions">
                      ...
                      {['in_garage', 'inspection_done', 'repair_in_progress', 'work_complete'].includes(b.status) && (
                        <span style={{ fontSize: '13px', color: '#64748b', fontStyle: 'italic' }}>
                          🛠️ Undergoing repair in garage
                        </span>
                      )}
                      {['delivered', 'closed'].includes(b.status) && (
                        <span style={{ fontSize: '13px', color: '#10b981', fontWeight: '600' }}>
                          ✅ Job completed and closed
                        </span>
                      )}
