...
const EmergencyPickup = () => {
  ...
  const handleGetCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        setIsLocating(false);
        toast.error('Unable to retrieve GPS coordinates. Please select your city & area manually.');
      },
    ...
    <div style={{ background: '#ffffff', minHeight: '100vh', color: '#0f172a', fontFamily: "'Poppins', sans-serif" }}>
      ...
      <section style={{ 
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          <p style={{ fontSize: '15px', color: '#64748b', maxWidth: '600px', lineHeight: 1.6 }}>
            Stranded on the road? Dispatch a flatbed recovery truck or roadside service operator to your exact location in minutes.
          </p>
        </div>
      </section>
            ...
            <div className="col-lg-7">
              <div style={{
                ...
                <h2 style={{ fontSize: '20px', fontWeight: 800, color: '#0f172a', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <LuTruck size={22} color="#ef4444" /> Request Emergency Recovery
                </h2>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 700, color: '#334155', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '.03em' }}>
                        Your Stranded Location
                      </label>
                      
                      <div style={{ display: 'flex', gap: '10px', marginBottom: '12px' }}>
                        <div style={{ position: 'relative', flex: 1 }}>
                          <LuMapPin size={18} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }} />
                          <input
                            type="text"
                            placeholder="Enter street, landmark, or highway detail..."
                        ...
                        >
                          <LuNavigation size={15} color="#ef4444" />
